...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x313d
#define DXLIB_VERSION_STR _T( "3.13d" )
...
extern	int			GetDefaultState(				int *SizeX , int *SizeY , int *ColorBitDepth, int *RefreshRate = NULL ) ;		// 起動時のデスクトップの画面情報を取得する( SizeX:デスクトップの横解像度を格納する変数のポインタ  SizeY:縦解像度を格納する変数のポインタ  ColorBitDepth:画面カラービット数を格納する変数のポインタ )
...
extern	int			DrawRoundRect(	int x1, int y1, int x2, int y2, int rx, int ry,                 int Color, int FillFlag ) ;				// 角の丸い四角形を描画する
...
extern	int			DrawPixel3DD(    VECTOR_D Pos,                                                               int Color ) ;						// ３Ｄの点を描画する
extern	int			DrawLine3D(      VECTOR   Pos1,   VECTOR   Pos2,                                             int Color ) ;						// ３Ｄの線分を描画する
extern	int			DrawLine3DD(     VECTOR_D Pos1,   VECTOR_D Pos2,                                             int Color ) ;						// ３Ｄの線分を描画する
extern	int			DrawTriangle3D(  VECTOR   Pos1,   VECTOR   Pos2, VECTOR   Pos3,                              int Color, int FillFlag ) ;		// ３Ｄの三角形を描画する
extern	int			DrawTriangle3DD( VECTOR_D Pos1,   VECTOR_D Pos2, VECTOR_D Pos3,                              int Color, int FillFlag ) ;		// ３Ｄの三角形を描画する
extern	int			DrawCube3D(      VECTOR   Pos1,   VECTOR   Pos2,                            int DifColor, int SpcColor, int FillFlag ) ;		// ３Ｄの立方体を描画する
extern	int			DrawCube3DD(     VECTOR_D Pos1,   VECTOR_D Pos2,                            int DifColor, int SpcColor, int FillFlag ) ;		// ３Ｄの立方体を描画する
extern	int			DrawSphere3D(    VECTOR   CenterPos,                  float  r, int DivNum, int DifColor, int SpcColor, int FillFlag ) ;		// ３Ｄの球体を描画する
extern	int			DrawSphere3DD(   VECTOR_D CenterPos,                  double r, int DivNum, int DifColor, int SpcColor, int FillFlag ) ;		// ３Ｄの球体を描画する
extern	int			DrawCapsule3D(   VECTOR   Pos1,   VECTOR   Pos2,      float  r, int DivNum, int DifColor, int SpcColor, int FillFlag ) ;		// ３Ｄのカプセルを描画する
extern	int			DrawCapsule3DD(  VECTOR_D Pos1,   VECTOR_D Pos2,      double r, int DivNum, int DifColor, int SpcColor, int FillFlag ) ;		// ３Ｄのカプセルを描画する
...
extern	int			DrawCone3DD(     VECTOR_D TopPos, VECTOR_D BottomPos, double r, int DivNum, int DifColor, int SpcColor, int FillFlag ) ;		// ３Ｄの円錐を描画する
